...
import PopupNumberPrint from '../../../User-Interaction/PopupNumberPrint';
      ...
      <div className='flex flex-col justify-center items-center shadow-dashboard-content py-5 h-[70vh]'>
        ...
        <Space align='center' className=' flex justify-center w-full'>
          <Link
            ...
            className='w-[115px] bg-primary-50 rounded-lg border-primary-400  text-primary border-2  text-center px-[20px] py-[7px] font-bold hover:text-primary hover:border-primary'
          >
            Hủy bỏ
          </Link>
          <button
